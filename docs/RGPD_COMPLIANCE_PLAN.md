...
3. **Criar endpoint para GDPR data erasure request**
   ...
   - Envia notificação para Manager/Admin do condomínio
   - Manager deve aprovar (endpoint separado `POST /api/users/{id}/gdpr-erasure/approve`)
...
18. Criar testes de integração para cada entidade
