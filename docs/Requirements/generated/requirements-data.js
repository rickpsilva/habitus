...
const REQUIREMENTS = [
  ...
  },
  {
    ...
    "priority": "High",
    "status": "Draft",
    "description": "Residents of a condominium can cast one vote on an active poll of their own condominium, but only while the linked announcement is Published and the poll's closing date has not passed. Each vote is recorded per user; only one vote per resident per poll is allowed.",
    "acceptanceCriteria": [
  ...
  },
  {
    ...
    "priority": "Medium",
    "status": "Draft",
    "description": "Poll results are visible as aggregated counts per vote option after a resident has voted, and final results remain visible after the poll closes. Closed polls become read-only: no further votes are accepted once the closing date has passed.",
    "acceptanceCriteria": [
