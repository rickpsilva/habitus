...
All poll operations must be enforced server-side: only condominium administrators create polls, only residents of the owning condominium vote, double-voting is impossible even under concurrent requests, and votes are auditable.
