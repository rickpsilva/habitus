...
export default function FinancialPage() {
  ...
  const load = () => {
    setLoading(true);
    financialApi.getAll().then((r) => setRecords(r.data)).finally(() => setLoading(false));
  };
    ...
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-0.5">Gestão financeira do condomínio</p>
        </div>
        {isAdmin && (
          <button
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="text-center py-12 text-gray-400">Sem registos financeiros</div>
        ) : (
