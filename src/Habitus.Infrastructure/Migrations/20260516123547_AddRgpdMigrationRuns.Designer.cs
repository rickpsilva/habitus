...
namespace Habitus.Infrastructure.Migrations
{
    ...
    [Migration("20260516123547_AddRgpdMigrationRuns")]
    partial class AddRgpdMigrationRuns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.Invoice", b =>
                {
                    ...
                    b.Property<string>("CustomerAddressEncrypted")
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)");
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.RgpdMigrationRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("CondominiumRecordsUpdated")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("InvoiceRecordsUpdated")
                        .HasColumnType("integer");

                    b.Property<int>("LegacyValuesCleared")
                        .HasColumnType("integer");

                    b.Property<int>("OperationType")
                        .HasColumnType("integer");

                    b.Property<int>("RemainingCondominiumAddressLegacyCount")
                        .HasColumnType("integer");

                    b.Property<int>("RemainingCondominiumPaymentIbanLegacyCount")
                        .HasColumnType("integer");

                    b.Property<int>("RemainingCondominiumTaxIdLegacyCount")
                        .HasColumnType("integer");

                    b.Property<int>("RemainingInvoiceCustomerAddressLegacyCount")
                        .HasColumnType("integer");

                    b.Property<int>("RemainingInvoiceCustomerTaxIdLegacyCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("ValuesEncrypted")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.UserGdprConsent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.RgpdMigrationRun", b =>
                {
                    b.HasOne("Habitus.Domain.Entities.User", "TriggeredByUser")
                        .WithMany()
