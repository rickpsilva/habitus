...
namespace Habitus.Infrastructure.Migrations
{
    ...
    [Migration("20260824223247_AddPollVotes")]
    partial class AddPollVotes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.Announcement", b =>
                {
                    ...
                    b.HasIndex("CondominiumId", "Status", "IsPinned", "PublishedAt");
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.CommunicationSettings", b =>
                {
                    ...
                    b.Property<string>("EmailUsernameEncrypted")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.Condominium", b =>
                {
                    ...
                    b.Property<string>("ContactPhoneEncrypted")
                        .HasMaxLength(255)
                    ...
                    b.Property<string>("LocalityEncrypted")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
                    ...
                    b.Property<string>("PostalCodeEncrypted")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.ImpersonationSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.NotificationDispatchDelivery", b =>
                {
                    ...
                    b.HasIndex("Channel", "DispatchKey", "RecipientUserId", "RecipientExternalId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasIndex("CondominiumId", "ResidentId", "CreatedDate");
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.PlanFeature", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("f1000004-0000-0000-0000-000000000000"),
                            FeatureKey = "polls",
                            FeatureLabel = "Votações",
                            IsEnabled = false,
                            PlanId = new Guid("a0b0c001-0000-0000-0000-000000000000")
                        },
                        new
                        ...
                        new
                        {
                            Id = new Guid("f2000008-0000-0000-0000-000000000000"),
                            FeatureKey = "polls",
                            FeatureLabel = "Votações",
                            IsEnabled = false,
                            PlanId = new Guid("a0b0c002-0000-0000-0000-000000000000")
                        ...
                        new
                        {
                            Id = new Guid("f3000011-0000-0000-0000-000000000000"),
                            FeatureKey = "polls",
                            FeatureLabel = "Votações",
                            IsEnabled = true,
                            PlanId = new Guid("a0b0c003-0000-0000-0000-000000000000")
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.Poll", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.PollOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.PollVote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PollId", "VotedByUserId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.ReceiptTemplateSettings", b =>
                {
                    ...
                    b.Property<bool>("IncludeCondominiumName")
                        .HasColumnType("boolean");

                    b.Property<bool>("IncludeContactPhone")
                        .HasColumnType("boolean");

                    b.Property<bool>("IncludeEmail")
                        .HasColumnType("boolean");

                    b.Property<bool>("IncludeLocality")
                        .HasColumnType("boolean");

                    b.Property<bool>("IncludePostalCode")
                        .HasColumnType("boolean");

                    b.Property<bool>("IncludeTaxId")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.SystemAuthProviderSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("MicrosoftEnabled")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("SystemAuthProviderSettings");
                });
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.ImpersonationSession", b =>
                {
                    ...
                    b.HasOne("Habitus.Domain.Entities.User", "ImpersonatedUser")
                        .WithMany()
                        .HasForeignKey("ImpersonatedUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Habitus.Domain.Entities.User", "ImpersonatorUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.NotificationDispatchDelivery", b =>
                {
                    b.HasOne("Habitus.Domain.Entities.User", "RecipientUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.Poll", b =>
                {
                    ...
                    b.HasOne("Habitus.Domain.Entities.User", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.PollOption", b =>
                {
                    b.HasOne("Habitus.Domain.Entities.Poll", "Poll")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("Habitus.Domain.Entities.PollVote", b =>
                {
                    ...
                    b.HasOne("Habitus.Domain.Entities.PollOption", "PollOption")
                        .WithMany("Votes")
                        .HasForeignKey("PollOptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Habitus.Domain.Entities.User", "VotedByUser")
                        .WithMany()
